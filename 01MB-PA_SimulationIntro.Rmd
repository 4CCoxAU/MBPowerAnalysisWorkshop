...
SimulateData <- function(
  n_subj = 24,   # number of subjects
  ADS_n  = 8,   # number of ingroup stimuli
  IDS_n =  8,   # number of outgroup stimuli
...
Exercise 2: How would you add a positive effect of (cross-sectional) age as a predictor to the model (hint: it involves randomly sampling age for each child and adding an effect to the simulation code and model)?
...
model <- glmer(RT ~ 1 + category_contrast + (1 + category_contrast | subj_id), 
               data = try, 
               family = Gamma(link = "log"))

model_try <- lmer(RT ~ 1 + category_contrast + (1 + category_contrast | subj_id), data = try)
